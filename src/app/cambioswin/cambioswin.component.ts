...
export class CambioswinComponent implements OnInit {
  ...
  clickEnviarAsg() {
    ...
    this.enviarPeticion(
      json,
      "http://192.168.1.76:3003/windows/cambioAsg",
      "http://192.168.1.76:3003/windows/cambioAsgR"
    );
  }
  ...
  clickEnviarEmp() {
    ...
    this.enviarPeticion(
      json,
      "http://192.168.1.76:3003/windows/cambioEmp",
      "http://192.168.1.76:3003/windows/cambioEmpR"
    );
  }
  ...
  clickEnviarPay() {
    ...
    this.enviarPeticion(
      json,
      "http://192.168.1.76:3003/windows/cambioPay",
      "http://192.168.1.76:3003/windows/cambioPayR"
    );
  }
  ...
  clickEnviarProj() {
    ...
    this.enviarPeticion(
      json,
      "http://192.168.1.76:3003/windows/cambioProj",
      "http://192.168.1.76:3003/windows/cambioProjR"
    );
  }
