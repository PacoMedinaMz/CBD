...
export class BajaswinComponent implements OnInit {
  ...
  clickEnviarEmp(thas) {
    ...
    thas.enviarPeticion(
      id,
      "http://192.168.1.76:3003/windows/bajaEmp",
      "http://192.168.1.76:3003/windows/bajaEmpR"
    );
  }
  ...
  clickEnviarPay(thas) {
    ...
    thas.enviarPeticion(
      id,
      "http://192.168.1.76:3003/windows/bajaPay",
      "http://192.168.1.76:3003/windows/bajaPayR"
    );
  }
  ...
  clickEnviarProj(thas) {
    ...
    thas.enviarPeticion(
      id,
      "http://192.168.1.76:3003/windows/bajaProj",
      "http://192.168.1.76:3003/windows/bajaProjR"
    );
  }
